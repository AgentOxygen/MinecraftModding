...
public class ModOreGen {
	...
	public static void generateOre() {
		for(Biome biome : ForgeRegistries.BIOMES) {
			...
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
					Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
							ModBlocks.bituminous_coal_ore.get().getDefaultState(), 5)).func_227228_a_(bituminous_config_default));
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
					Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
							ModBlocks.argentite_ore.get().getDefaultState(), 2)).func_227228_a_(argentite_config));
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
					Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
							ModBlocks.cinnabar_ore.get().getDefaultState(), 3)).func_227228_a_(cinnabar_config));
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
					Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
							ModBlocks.cobalt_ore.get().getDefaultState(), 5)).func_227228_a_(cobalt_config));
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
					Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
							ModBlocks.corundum_ore.get().getDefaultState(), 3)).func_227228_a_(corundum_config));
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
					Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
							ModBlocks.cuprite_ore.get().getDefaultState(), 2)).func_227228_a_(cuprite_config));
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
					Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
							ModBlocks.hematite_ore.get().getDefaultState(), 8)).func_227228_a_(hematite_config));
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
					Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
							ModBlocks.malachite_ore.get().getDefaultState(), 8)).func_227228_a_(malachite_config));
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
					Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
							ModBlocks.monazite_ore.get().getDefaultState(), 1)).func_227228_a_(monazite_config));
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
					Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
							ModBlocks.siderite_ore.get().getDefaultState(), 8)).func_227228_a_(siderite_config));
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
					Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
							ModBlocks.topaz_ore.get().getDefaultState(), 4)).func_227228_a_(topaz_config));
			
			// Add Peat to Dirt
			biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
					Feature.DISK.func_225566_b_(new SphereReplaceConfig(ModBlocks.peat_ore.get().getDefaultState(), 4, 1, Lists.newArrayList(Blocks.DIRT.getDefaultState(), ModBlocks.peat_ore.get().getDefaultState())))
			...
			if(biome == Biomes.SWAMP || biome == Biomes.SWAMP_HILLS) {
				biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
						Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
								ModBlocks.anthracite_ore.get().getDefaultState(), 4)).func_227228_a_(anthracite_config));
				biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
						Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
								ModBlocks.bituminous_coal_ore.get().getDefaultState(), 10)).func_227228_a_(bituminous_config_swamp));
			}
			if(biome == Biomes.MOUNTAINS || biome == Biomes.TAIGA_MOUNTAINS || biome == Biomes.MOUNTAIN_EDGE) {
				biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
						Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
								ModBlocks.magnetite_ore.get().getDefaultState(), 5)).func_227228_a_(magnetite_config));
			}
			if(biome == Biomes.BEACH || biome == Biomes.DEEP_COLD_OCEAN || biome == Biomes.DEEP_FROZEN_OCEAN 
				...
				biome.addFeature(GenerationStage.Decoration.UNDERGROUND_ORES, 
						Feature.ORE.func_225566_b_(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE,
								ModBlocks.uraninite_ore.get().getDefaultState(), 3)).func_227228_a_(uraninite_config));
			}
			// Spawns Salt Beds
			if(biome == Biomes.DESERT || biome == Biomes.DESERT_HILLS || biome == Biomes.DESERT_LAKES) {
				biome.addFeature(GenerationStage.Decoration.LOCAL_MODIFICATIONS, Feature.LAKE.func_225566_b_(new BlockStateFeatureConfig(ModBlocks.rock_salt.get().getDefaultState())).func_227228_a_(Placement.LAVA_LAKE.func_227446_a_(new ChanceConfig(40))));
			}
		}
	}
}
