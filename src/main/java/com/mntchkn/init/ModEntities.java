...
public class ModEntities {
	public static EntityType<?> TEST_ENTITY = EntityType.Builder.create(TestEntity::new, EntityClassification.CREATURE).build(Main.MODID + ":test_entity").setRegistryName(ModEventSubscriber.location("test entity"));
